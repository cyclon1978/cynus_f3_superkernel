...
#define VOLTAGE_S VOLTAGE_S_UV_4
#define VOLTAGE_0 VOLTAGE_0_UV_4
#define VOLTAGE_1 VOLTAGE_1_UV_4
#define VOLTAGE_2 VOLTAGE_2_UV_4
#define VOLTAGE_3 VOLTAGE_3_UV_4
